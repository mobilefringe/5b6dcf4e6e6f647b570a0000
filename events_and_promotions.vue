                            ...
                            if (_.includes(value.event_image_url_abs, 'missing')) {
                                if (value.store != null && value.store != undefined) {
                                    if (_.includes(value.store.store_front_url_abs, 'missing')) {
                                        value.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7017836e6f641aaf4f0000/image/jpeg/1537463477000/ewp-events-compressor.jpg";
                                    } else {
                    ...
                    _.forEach(this.processedPromos, function(value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            if (_.includes(value.promo_image_url_abs, 'missing')) {
                                if (value.store != null && value.store != undefined) {
                                    if (_.includes(value.store.store_front_url_abs, 'missing')) {
                                        value.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7017836e6f641aaf4f0000/image/jpeg/1537463505000/ewp_promo-compressor.jpg";
                                    } else {
                                        value.image_url = value.store.store_front_url_abs;
                                    }
                                } else {
