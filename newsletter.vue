                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="newsletter_form form-horizontal" action="//mobilefringe.createsend.com/t/d/s/ejdhrl/" method="post">
                                <div class="row">
                                    <div class="col-sm-6" >
                                        <label for="fieldzhtulk" class="visuallyhidden">First Name</label>
                                    ...
                                    <div class="col-sm-6" >
                                        <label for="fieldzhtulu" class="visuallyhidden">Last Name</label>
                                        <input v-model="form_data.last_name" required class="margin_20 form-control" id="fieldzhtulu" name="cm-f-zhtulu" type="text" placeholder="Last Name">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
